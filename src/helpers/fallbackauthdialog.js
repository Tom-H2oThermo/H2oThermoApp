...
const msalConfig = {
  auth: {
    ...
    redirectUri: "https://h2othermo-sso-web-app.azurewebsites.net/fallbackauthdialog.html", // Update config script to enable `https://${window.location.host}/fallbackauthdialog.html`,
